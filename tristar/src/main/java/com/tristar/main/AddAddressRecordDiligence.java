...
public class AddAddressRecordDiligence extends Activity implements
		OnClickListener {
	...
	public void onClick(View v) {
		...
		if (v == back || v == imageButtonback) {
			...
			if (street.getText().length() == 0 || city.getText().length() == 0
				...
				Toast.makeText(AddAddressRecordDiligence.this,
	...
	private  void dialogType(){
		final Dialog dialog = new Dialog(AddAddressRecordDiligence.this);
	...
	private void saveAllValuesInDB() {
		...
		Toast.makeText(AddAddressRecordDiligence.this,
				"Address saved successfully", Toast.LENGTH_LONG).show();
