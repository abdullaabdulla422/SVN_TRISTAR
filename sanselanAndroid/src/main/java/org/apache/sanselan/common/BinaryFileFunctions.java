...
public class BinaryFileFunctions implements BinaryConstants
{
	...
	public static byte[] tail(byte bytes[], int count)
	{
	...
	public static boolean compareBytes(byte a[], int aStart, byte b[],
									   int bStart, int length)
	{
		if (a.length < (aStart + length))
			return false;
