...
public final class TiffOutputSet implements TiffConstants
{
			...
			throws ImageWriteException
	{
...

		{
			...
			Double values[] = {
					Double.valueOf(longitudeDegrees), Double.valueOf(longitudeMinutes),
					Double.valueOf(longitudeSeconds),
			};
...

		{
			...
			Double values[] = {
					Double.valueOf(latitudeDegrees), Double.valueOf(latitudeMinutes),
					Double.valueOf(latitudeSeconds),
			};
