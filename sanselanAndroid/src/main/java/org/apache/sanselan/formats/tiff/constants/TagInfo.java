...
public class TagInfo implements TiffDirectoryConstants, TiffFieldTypeConstants
{
	...
	public static class Offset extends TagInfo
	{
		...
		public Offset(String name, int tag,
					  ExifDirectoryType exifDirectory)
		{
			super(name, tag, TiffFieldTypeConstants.FIELD_TYPE_LONG, 1, exifDirectory);
		}
	...
	public static final class Text extends TagInfo
	{
		public Text()
		{
			super("UserComment", 0x9286, TiffFieldTypeConstants.FIELD_TYPE_UNDEFINED, 1, TiffDirectoryConstants.EXIF_DIRECTORY_EXIF_IFD);
		}

		public Text(String name, int tag, int length)
		{
			super(name, tag, TiffFieldTypeConstants.FIELD_TYPE_DESCRIPTION_UNKNOWN, length, TiffDirectoryConstants.EXIF_DIRECTORY_GPS);
		}
	...
	public static final class Unknown extends TagInfo
	{
		...
		public Unknown(int tag, int length,
					   ExifDirectoryType exifDirectory)
		{
			super("Unknown Tag", tag, TiffFieldTypeConstants.FIELD_TYPE_DESCRIPTION_UNKNOWN, length, exifDirectory);
		}
